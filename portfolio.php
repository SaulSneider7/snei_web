    ...
    <footer class="bg-[#020202] border-t border-white/10">
        <div class="max-w-7xl mx-auto px-6 py-10 grid grid-rows-[auto_1fr_auto] gap-6">
            ...
            <div class="flex items-center justify-center">
                <a href="https://wa.me/51917794918?text=Hola,%20vi%20su%20portafolio%20y%20quiero%20crear%20un%20proyecto%20web."
                    target="_blank" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl
